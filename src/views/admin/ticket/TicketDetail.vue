            ...
            <div class="p-6 border-t border-gray-100">
                ...
                <form @submit.prevent="handleSubmit" class="space-y-4">
                    ...
                    <div>
                        ...
                        class="w-full px-4 py-3 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500":class="{ 'border-red-500 ring-red-500': error?.content}"
